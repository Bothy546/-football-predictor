...
public class MainActivity extends Activity {
        ...
        executor.execute(() -> {
            try {
                ...
                if (!yesterday.isEmpty() && !yesterday.equals(today)) {
                    String[] types = {"safe", "medium", "risky", "smart", "extreme1", "extreme2"};
        ...
        try {
            ...
            for (int i = 0; i < matches.length(); i++) {
                try {
                    ...
                    // Skip this match if there's any error
                    continue;
                }
            }
    ...
    private void displayDailyTickets() {
        ...
        // SAFE ZONE
        layout.addView(createZoneHeader("🛡️ SAFE ZONE", "Low Risk • High Win Rate", "#4CAF50"));
        ...
        // BALANCED ZONE
        layout.addView(createZoneHeader("⚖️ BALANCED ZONE", "Medium Risk • Good Value", "#FF9800"));
        ...
        // HIGH REWARD ZONE
        layout.addView(createZoneHeader("🚀 HIGH REWARD ZONE", "Higher Risk • Massive Payout", "#F44336"));
    ...
    private TextView createZoneHeader(String title, String subtitle, String color) {
